...
export default function Step3Offices({ data, onChange }) {
  ...
  const maxMezzanineHeight = Math.min(5.0, (data.height || 10) - 4);
  ...
  const positionOptions = [
    { value: 'front_left', label: 'Frontal Izquierda', icon: '↖️' },
    { value: 'front_right', label: 'Frontal Derecha', icon: '↗️' },
    { value: 'front_center', label: 'Frontal Centro', icon: '⬆️' },
    { value: 'back_left', label: 'Trasera Izquierda', icon: '↙️' },
    { value: 'back_right', label: 'Trasera Derecha', icon: '↘️' }
  ];
